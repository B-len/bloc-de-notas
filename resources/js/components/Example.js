                ...
                <div className="row">
                    <form onSubmit={(e)=>this.submit(e,this.state.id)}>
                        <div className="input-field col s4">
                            <i>Título</i>
                            <input placeholder="Escriba el título" onChange={(e)=>this.titlechange(e)} value={this.state.title}/>
                        </div>
                        <div className="input-field col s4">
                            <i>Texto</i>
                            <input placeholder="Escriba el texto que desee" onChange={(e)=>this.bodychange(e)} value={this.state.body}/>
                        </div>
                            ...
                            <tr key={post.id}>
                                ...
                                <td>
                                    <button onClick={(e)=>this.getOne(post)} className="waves-effect waves-light btn">
                                        <i className="material-icons prefix">EDITAR</i>
                                    </button>
                                </td>
                                <td>
                                    <button onClick={(e)=>this.delete(post.id)} className="waves-effect waves-light btn">
                                        <i className="material-icons prefix">BORRAR</i>
                                    </button>
                                </td>
                            </tr>
                        )}
